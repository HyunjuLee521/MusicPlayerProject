...
public class SelectSongBySongFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(com.hj2.user.musicplayerproject.R.layout.activity_select_songbysong, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) view.findViewById(com.hj2.user.musicplayerproject.R.id.selectsongbysong_recyclerview);
...
//                Toast.makeText(SelectSongActivity.this, "view.getTag() : " + view.getTag(), Toast.LENGTH_SHORT).show();
    ...
    public static class SongRecyclerAdapter extends CursorRecyclerViewAdapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(com.hj2.user.musicplayerproject.R.layout.select_song_item, parent, false));
        }
...
//                Toast.makeText(mContext, "마지막 cursor에 저장되어있는 data갯수 : " + mArtistNameData.size(), Toast.LENGTH_SHORT).show();
                /**
                 * {@link SelectSongByArtistFragment#getArtistNameList(ArrayList<ArtistName>)}
                 */
...
//                Toast.makeText(mContext, String.valueOf(position), Toast.LENGTH_SHORT).show();
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            titleTextView = (TextView) itemView.findViewById(com.hj2.user.musicplayerproject.R.id.title_textview);
            artistTextView = (TextView) itemView.findViewById(com.hj2.user.musicplayerproject.R.id.artist_textview);
        }
    }
