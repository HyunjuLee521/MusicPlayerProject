...
import com.hj2.user.musicplayerproject.fragments.SelectSongFragments.SelectSongByArtistFragment;
import com.hj2.user.musicplayerproject.fragments.SelectSongFragments.SelectSongBySongFragment;
...
public class SelectSongActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.hj2.user.musicplayerproject.R.layout.activity_select_song);
        ...
        // 뷰페이저에 어댑터 꽂기
        mViewPager = (ViewPager) findViewById(com.hj2.user.musicplayerproject.R.id.view_pager);
        PagerAdapter mAdapter = new PagerAdapter(getSupportFragmentManager());
        mViewPager.setAdapter(mAdapter);


        TabLayout mTabLayout = (TabLayout) findViewById(com.hj2.user.musicplayerproject.R.id.tab_layout);
        ...
        Button sendButton = (Button) findViewById(com.hj2.user.musicplayerproject.R.id.send_button);
