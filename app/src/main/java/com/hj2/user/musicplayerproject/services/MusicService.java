package com.hj2.user.musicplayerproject.services;
...
//                        mMediaPlayer = null;
                        ...
                        /**
                         * {@link MusicControllerFragment#updateResumeImageview(Boolean)}
                         */
...
//                    Toast.makeText(MusicService.this, mIndex + "번 째 음악을 재생합니다", Toast.LENGTH_SHORT).show();
                    ...
                    /**
                     * {@link PlayerFragment#updateUI2(Boolean)}
                     * {@link MusicControllerFragment#updateResumeImageview(Boolean)}
                     */
                    EventBus.getDefault().post(isPlaying());
                    ...
                    /**
                     * {@link MusicControllerFragment#updateAlbumImage(MediaMetadataRetriever)}
                     */
...
//        EventBus.getDefault().post(mRetriever);
        ...
        /**
         * {@link PlayerFragment#restartMainUpdateUI(MyUtils.restartUpdateUiEvent)}
         */
